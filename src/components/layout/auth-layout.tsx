  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Seller Panel - Authentication and account management for sellers." />
            ...
            <div className="p-8 lg:p-12 flex items-center">
              <div className="flex flex-col gap-6 w-full max-w-md mx-auto lg:mx-0 lg:max-w-none">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <span className="mt-2 inline-block px-3 py-1 text-xs font-semibold bg-purple-100 text-purple-700 rounded-full">Seller Panel</span>
                </div>
            ...
            <div className="bg-gradient-to-br from-indigo-500/10 to-purple-600/5 relative hidden lg:block">
              ...
              <div className="relative h-full flex items-center justify-center p-12">
                <div className="text-center space-y-4">
                  ...
                  <span className="inline-block px-3 py-1 text-xs font-semibold bg-purple-100 text-purple-700 rounded-full">Seller Panel</span>
                </div>
              </div>
            </div>
          </CardContent>
